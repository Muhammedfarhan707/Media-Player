...
function Addvideos({setAddStatus}) {
    ...
    const getdata = (e) => {
        ...
        if (name === 'url') {
            ...
            furl = furl.split('v=')
            // console.log(furl)
            let vurl = `https://www.youtube.com/embed/${furl[1]}?9OhV3IWUsxE?si=9XadOjOiCLDiryI2`
    ...
    return (
        <>
            <span className='btn border-light' onClick={handleShow}>
                <i className="fa-solid fa-plus fa-lg" style={{color:'#337357'}}></i>
            </span>
            <Modal
                show={show}
                onHide={handleClose}
